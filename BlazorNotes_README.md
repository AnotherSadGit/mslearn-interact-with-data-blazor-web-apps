...
------------
### @bind directive
Via @bind directive.  For example:
...
The event that causes the update can be changed via the @bind-value:event directive.  In that case the @bind-value directive is also needed.  For example:
...
Specifies the format for entering data.  For example, when entering a date:
